	 ...
	 <div class="contents">
            <div class="container">
				<div class="welcome-text" align="left">	  			
					<br><br>
					<%long avail = (Long)session.getAttribute("avail_faculty");
					long unavail = (Long)session.getAttribute("unavail_faculty");
					long total = avail+unavail;%>
					<h2>Total number of Faculty = <%=total %></h2><br>
					<h2>Faculties available = <%=avail %></h2><br>
					<h2>Faculties on leave  = <%=unavail %></h2>
					<br><br>
