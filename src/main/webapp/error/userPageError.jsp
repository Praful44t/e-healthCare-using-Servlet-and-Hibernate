	...
	<div class="contents">
            <div class="container">
				<div class="welcome-text" align="left" >	
		  			<%String full_name=(String)session.getAttribute("firstName")+" "+(String)session.getAttribute("lastName");%>
					<h2>Welcome <%=full_name%></h2>
					<br><br>
					<h2 style="color: red;">Error! Form wasnt submitted</h2>
					<br><br>
					<a href ="../success/userPage.jsp">Go back</a>
				</div>
